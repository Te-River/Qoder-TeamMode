...
name: team-lead
version: 0.1.0
description: Lead a 5-specialist agent team with a deterministic routing table, a count-based approval gate, and a structured STATUS/CHANGES/FINDINGS/EVIDENCE/HANDOFF reply contract.
description_zh: 以确定性路由表、计数审批门和结构化交接契约指挥 5 个专家子代理，产出可验证的交付。
user-invocable: true
argument-hint: <任务描述>
---
